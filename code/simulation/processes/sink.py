...
c_sql = 'INSERT INTO de_sim_data_commuter (c_id, rerun, leaving_time, route_home_distance, route_work_distance, fuel_type, tank_filling, driven_distance, error, filling_stations) ' \
        'VALUES (%(c_id)s, %(rerun)s, %(leaving_time)s, %(route_home_distance)s, %(route_work_distance)s, %(fuel_type)s, %(tank_filling)s, %(driven_distance)s, %(error)s, %(filling_stations)s)'
