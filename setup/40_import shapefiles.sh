...
shp2pgsql -I -W 'LATIN1' -s 4326 -a VG250_Bundeslaender.shp de_shp_bundeslaender | psql -U $USER -d $DATABASE -q

infoMsg "Import Kreise"
shp2pgsql -I -W 'LATIN1' -s 4326 -a VG250_Kreise.shp de_shp_kreise | psql -U $USER -d $DATABASE -q

infoMsg "Import Gemeinden"
shp2pgsql -I -W 'LATIN1' -s 4326 -a VG250_Gemeinden.shp de_shp_gemeinden | psql -U $USER -d $DATABASE -q
